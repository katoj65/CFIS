...
Route::get('user/calculator/emission/energy-consumption/{id}', [UserCalculator::class, 'hydropowerUsage'])->name('user.energy-consumption');
...
Route::get('user/calculator/emission/transportation/{id}', [UserController::class, 'transportationPage'])->name('user.transportation');
