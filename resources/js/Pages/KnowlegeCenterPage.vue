...
<section class="bg-dark pl-5 pr-5 pt-5" style="margin-top:-25px;border-bottom:solid 3px red;">
<div class="row">
...
<span style="padding:10px;background:red;text-shadow:none;padding-left:25px;padding-right:25px;" class="text-white">HUB</span></h3>
</div>
       ...
       <div class="row gy-4">
          <div class="col-xl-3">
             <div class="card border-0 h-100" data-bs-theme="dark">
                <img src="http://localhost/carbon/public/images/carbon.jpg" alt="" class="rounded-3 img-fluid w-100 object-fit-cover horizontal-img" />
...
data(){return{
images:{
background:'http://localhost/carbon/public/images/deforestation.jpeg',
climate_impact:'http://localhost/carbon/public/images/climate_change_impact.png',
...
.cover2{
background-image: url('http://localhost/carbon/public/images/carbon.jpg');
